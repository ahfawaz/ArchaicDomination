...
const TCHAR*	g_szWINDOW_CLASS_NAME	= _T("SGP Game Project");				//	Window Class Name.
const TCHAR*	g_szWINDOW_TITLE		= _T("Archaic Domination");				//	Window Title.
const int		g_nWINDOW_WIDTH			= 800;									//	Window Width.
const int		g_nWINDOW_HEIGHT		= 600;									//	Window Height.
const BOOL		g_bIS_WINDOWED			= TRUE;									
//	Window Status: Windowed / Fullscreen
	...
	case WM_ACTIVATE:
		{
			...
			else									//	losing focus
			{
				...
				//pXA->MusicPlaySong( CGame::GetInstance()->GetMusicID(), true );
			}
		}
		break;
