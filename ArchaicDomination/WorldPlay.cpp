...
CWorldPlay* CWorldPlay::GetInstance( void )
{

	//Global Instance
	static CWorldPlay s_Instance;
	return &s_Instance;
...
bool CWorldPlay::Input			( void )	
{
	...
	if (m_bChooseToSellBack)
	{
		HandleAllInputForSellOrKeep();
	}
	else if (m_bBuildInterface == false && m_bAMMode == false && m_bTerritoryMenuUp == false && m_bRecruitInterface == false)
	{
...
void CWorldPlay::Update			( float fElapsedTime )	
{
	...
	//Cheat on
	if (m_bCheatPlayerOne)
	{
		m_cPlayerOne->SetWood(1000);
		m_cPlayerOne->SetFood(1000);
		m_cPlayerOne->SetSteel(1000);
	}
	else if (m_bCheatPlayerTwo)
	{
		m_cPlayerTwo->SetWood(1000);
		m_cPlayerTwo->SetFood(1000);
		m_cPlayerTwo->SetSteel(1000);	
	}
...
void CWorldPlay::Enter			( void )	
{
	...
	m_bCheatPlayerOne = false;
	m_bCheatPlayerTwo = false;



	m_nBackgroundID =  CSGD_TextureManager::GetInstance()->LoadTexture( _T( "resources/graphics/IC_MapB.png") );
...
bool CWorldPlay::Move( CWorldTile * Tiletomove, int temp )
{
...
void CWorldPlay::Build( CBasePlayer* TempPlayer )
{
...
void CWorldPlay::CheckIsBuilt	( int count )
{
...
void CWorldPlay::InterfaceRender ( void )
{
	//Renders army roster for currently highlighted territory
	if(m_cWorld->GetCurrent()->GetOwner() != 0)
	{
...
void CWorldPlay::BuildRender		( void )
{
...
void CWorldPlay::RecruitRender	( void )
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
...
void CWorldPlay::RenderBuildings ( void )
{
...
void CWorldPlay::RenderUnits		( void )
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
	CSGD_TextureManager* pTM = CSGD_TextureManager::GetInstance();
	...
	if(m_cWorld->GetCurrent()->GetOwner() == 1)
	{
		...
		pFont->Draw(_T("Units in Territory: "),300,450,0.76f,D3DCOLOR_ARGB(255,0,0,0));
...
void CWorldPlay::RenderOwnership	( void )
{
	CSGD_TextureManager* pTM = CSGD_TextureManager::GetInstance();
...
void CWorldPlay::AllocateResources(void )
{
	m_fTime = 0;
...
bool CWorldPlay::WinCheck		( void )
{
	...
	if (m_bPlayerOneWins == 16 || m_cPlayerTwo->GetUnits().size() == 0)
	{
		return true;
	}
	else if (m_bPlayerTwoWins == 16	|| m_cPlayerOne->GetUnits().size() == 0)
	{
		return true;
	}
	else if (m_bPlayerOneWins != 16	|| m_cPlayerTwo->GetUnits().size() != 0)
	{
		return false;
	}
	else if (m_bPlayerTwoWins != 16	|| m_cPlayerOne->GetUnits().size() != 0)
...
bool CWorldPlay::SellBuilding	( void )
{
	int wood;
	int steel;
...
void CWorldPlay::RenderOptionsForMove( void )
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
	...
	if(m_cWorld->GetPrevious()->GetOwner() == 1)
	{
		...
		pFont->Draw(_T("Units in Territory: "),250,100,1.5f,D3DCOLOR_ARGB(255,0,0,255));

		if(generalPresent)
		{
			pFont->Draw(_T("General in Command"),200,150,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		}

		pFont->Draw(_T("Foot Soldiers "),200,200,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(fs.str().c_str(),150,    200,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(Mfs.str().c_str(),650,   200,1.0f,D3DCOLOR_ARGB(255,0,0,255));


		pFont->Draw(_T("Priests "),200,250,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(p.str().c_str(),150,250,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(Mp.str().c_str(),650,250,1.0f,D3DCOLOR_ARGB(255,0,0,255));

		pFont->Draw(_T("Wizards "),200,300,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(w.str().c_str(),150,300,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(Mw.str().c_str(),650,300,1.0f,D3DCOLOR_ARGB(255,0,0,255));

		pFont->Draw(_T("Cavalry "),200,350,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(cv.str().c_str(),150,350,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(Mcv.str().c_str(),650,350,1.0f,D3DCOLOR_ARGB(255,0,0,255));

		pFont->Draw(_T("Catapults "),200,400,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(cp.str().c_str(),150,400,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(Mcp.str().c_str(),650,400,1.0f,D3DCOLOR_ARGB(255,0,0,255));


		pFont->Draw(_T("How Many to Move? "),400,200,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(_T("How Many to Move? "),400,250,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(_T("How Many to Move? "),400,300,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(_T("How Many to Move? "),400,350,1.0f,D3DCOLOR_ARGB(255,0,0,255));
		pFont->Draw(_T("How Many to Move? "),400,400,1.0f,D3DCOLOR_ARGB(255,0,0,255));


		pFont->Draw(_T("Move To Territory! "),300,450,1.0f,D3DCOLOR_ARGB(255,0,0,255));

		pFont->Draw(_T("Exit Move"),300,500,1.0f,D3DCOLOR_ARGB(255,0,0,255));
	...
	else if(m_cWorld->GetPrevious()->GetOwner() == 2)
	{
		...
		pFont->Draw(_T("Units in Territory: "),350,100,1.5f,D3DCOLOR_ARGB(255,255,0,0));


		if(lichPresent)
		{
			pFont->Draw(_T("Lich in Command"),200,150,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		}

		pFont->Draw(_T("Skeletal Warriors "),200,200,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(sw.str().c_str(),150,200,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(Msw.str().c_str(),650,200,1.0f,D3DCOLOR_ARGB(255,255,0,0));


		pFont->Draw(_T("Shadow Priests "),200,250,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(sp.str().c_str(),150,250,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(Msp.str().c_str(),650,250,1.0f,D3DCOLOR_ARGB(255,255,0,0));


		pFont->Draw(_T("Necromancers "),200,300,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(n.str().c_str(),150,300,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(Mn.str().c_str(),650,300,1.0f,D3DCOLOR_ARGB(255,255,0,0));

		pFont->Draw(_T("Death Knights "),200,350,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(dk.str().c_str(),150,350,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(Mdk.str().c_str(),650,350,1.0f,D3DCOLOR_ARGB(255,255,0,0));

		pFont->Draw(_T("War Machines "),200,400,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(wm.str().c_str(),150,400,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(Mwm.str().c_str(),650,400,1.0f,D3DCOLOR_ARGB(255,255,0,0));

		pFont->Draw(_T("How Many to Move? "),400,200,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(_T("How Many to Move? "),400,250,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(_T("How Many to Move? "),400,300,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(_T("How Many to Move? "),400,350,1.0f,D3DCOLOR_ARGB(255,255,0,0));
		pFont->Draw(_T("How Many to Move? "),400,400,1.0f,D3DCOLOR_ARGB(255,255,0,0));


		pFont->Draw(_T("Move To Territory! "),300,450,1.0f,D3DCOLOR_ARGB(255,255,0,0));

		pFont->Draw(_T("Exit Move"),300,500,1.0f,D3DCOLOR_ARGB(255,255,0,0));


	}
}
bool CWorldPlay::HandleInputForMoveAndAttack( void )   //done
{
...
void CWorldPlay::CheckMovement ( void )
{
	...
	if (m_cWorld->GetCurrent() == m_cWorld->GetPrevious())
	{
		m_bAMMode = true;
	}
...
bool CWorldPlay::MoveUnitsBetweenTerritories ( void )
{
				...
				case SKELETALWARRIOR:
					{
						if(m_MoveskeletonCount > 0)
						{
							...
							m_cPlayerTwo->GetUnits()[i]->SetTerritory(m_cWorld->GetCurrent()->GetTerritory());
...
void CWorldPlay::RenderResources ( void )
{
...
void CWorldPlay::TurnRender( void )
{
	...
	if(CMainMenu::GetInstance()->GetQuickMatch())
	{
		stringstream ss;
		ss << "Rounds Left:\n                     " << this->m_nTurnCap - this->m_nTurnNumber;
		TCHAR tBuffer[64];
		mbstowcs_s(nullptr,tBuffer,ss.str().c_str(),64);
		pFont->Draw(tBuffer, 323, 44, 1.1f, D3DCOLOR_ARGB(255, 0, 0, 0) );
		pFont->Draw(tBuffer, 324, 45, 1.0f, D3DCOLOR_ARGB(255, 255, 255, 255) );
	}

}
void CWorldPlay::PlayerResources(void)
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
	CSGD_TextureManager* pTM = CSGD_TextureManager::GetInstance();
...
void CWorldPlay::LoadBackFromBattle()
{
	if (m_cWorld->GetCurrent() != nullptr)
	{
		if (m_ncurrentPlayer->GetType() == PLAYER && m_cWorld->GetCurrent()->GetOwner() == 1 && m_cWorld->GetCurrent()->GetBuilding() != -1)
		{
			m_bChooseToSellBack = true;
		}
		else if (m_ncurrentPlayer->GetType() == ENEMY && m_cWorld->GetCurrent()->GetOwner() == 2 && m_cWorld->GetCurrent()->GetBuilding() != -1)
		{
			m_bChooseToSellBack = true;
		}
...
void CWorldPlay::RenderTileCursor(void)
{
	CSGD_TextureManager * pTM = CSGD_TextureManager::GetInstance();
...
void CWorldPlay::ShowTerritoryOptions(void)
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
	CSGD_TextureManager* pTM = CSGD_TextureManager::GetInstance();
...
bool CWorldPlay::CheatCheck(void)
{
...
bool CWorldPlay::HandleMovingOnTerritoryMenu( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
bool CWorldPlay::HandleMovingOnBuildInterface( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
bool CWorldPlay::HandleMovingOnRecruitInterface( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
bool CWorldPlay::HandleMovingOnTerritories( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
bool CWorldPlay::HandleEnterForMoveAndAttack( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
		...
		case 5:
			{
				if (m_nTurnOrder == 0)
				{
					if (m_cWorld->GetCurrent()->GetOwner() == 2)
					{
						...
						if(MoveUnitsBetweenTerritories())
						{
							...
							curY = m_cWorld->GetCurrent()->GetTerritory();
				...
				else if (m_nTurnOrder == 1)
				{
					...
					else if (m_cWorld->GetCurrent()->GetOwner() == 2)  //Moving to territories you own
					{
						m_bAMMode = false;
						m_bSelectTerritoryToMove = false;
						m_bIsMoving = false;
...
bool CWorldPlay::HandleEnterForClickingOnTerritories( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
bool CWorldPlay::HandleEnterOnTerritoryMenu( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
	...
	if( ( pDI->KeyPressed( DIK_TAB ) || pDI->JoystickButtonPressed( 1, JOYSTICKID1 ) && m_ncurrentPlayer->GetType() == PLAYER ) || (pDI->KeyPressed( DIK_RETURN ) || pDI->JoystickButtonPressed( 1, JOYSTICKID2 ) && m_ncurrentPlayer->GetType() == ENEMY ) )
	{
		...
		{
			if (m_nTerritoryOptionsCursor == 0)   //Handle Recruit 
			{
				Build( m_ncurrentPlayer );
				m_bTerritoryMenuUp = false;
				m_nTerritoryOptionsCursor = 0;
			...
			else if (m_nTerritoryOptionsCursor == 1)  ///Handle End Phase
			{
				m_bBuildMode = false;
				m_bMoveandAttackMode = true;
				m_bTerritoryMenuUp = false;
		...
		{
			if (m_nTerritoryOptionsCursor == 0) //Handle entering into move/attack 
			{
				m_bIsMoving = true;
				m_bTerritoryMenuUp = false;
				m_nTerritoryOptionsCursor = 0;
			...
			else if (m_nTerritoryOptionsCursor == 1)  //End phase for move and attack
			{
				m_bMoveandAttackMode = false;
				m_bTerritoryMenuUp = false;
				m_nTerritoryOptionsCursor = 0;
...
bool CWorldPlay::HandleEnterOnBuildInterface( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
	int wood, steel;
	wood = m_ncurrentPlayer->GetWood();
...
bool CWorldPlay::HandleEnterOnRecruitInterface( void )
{
			...
			if(m_cWorld->GetCurrent()->GetBuilding() == BARRACKS)
			{
				...
				case 0:			//Foot Soldier
					if(food >= 10)
					{
						...
						m_psRecruit->GetEffect(0)->SetEmitterPosX((float)m_cWorld->GetGrid()[m_cWorld->GetCurrent()->GetCountry()][m_cWorld->GetCurrent()->GetTerritory()]->GetPosX()-32);
						m_psRecruit->GetEffect(0)->SetEmitterPosY((float)m_cWorld->GetGrid()[m_cWorld->GetCurrent()->GetCountry()][m_cWorld->GetCurrent()->GetTerritory()]->GetPosY()+32);
					}
					break;
				case 1:			//Priest
					if(food >= 25)
...
void CWorldPlay::RenderSellOrKeep( void )
{
	CBitmapFont* pFont = CGame::GetInstance()->GetFont();
...
bool CWorldPlay::HandleAllInputForSellOrKeep( void )
{
	CSGD_DirectInput* pDI = CSGD_DirectInput::GetInstance();
...
void CWorldPlay::SellOrKeepBuilding( int temp )
{
